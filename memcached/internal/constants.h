...
enum memcached_response {
	MEMCACHED_RES_OK              = 0x00,
	MEMCACHED_RES_KEY_ENOENT      = 0x01,
	MEMCACHED_RES_KEY_EEXISTS     = 0x02,
	MEMCACHED_RES_E2BIG           = 0x03,
	MEMCACHED_RES_EINVAL          = 0x04,
	MEMCACHED_RES_NOT_STORED      = 0x05,
	MEMCACHED_RES_DELTA_BADVAL    = 0x06,
	MEMCACHED_RES_VBUCKET_BADVAL  = 0x07, /* No in memc */
	MEMCACHED_RES_AUTH_ERROR      = 0x20, /* OR 0x08 in revmapped */
	MEMCACHED_RES_AUTH_CONTINUE   = 0x21, /* OR 0x09 in revmapped */
	MEMCACHED_RES_UNKNOWN_COMMAND = 0x81,
	MEMCACHED_RES_ENOMEM          = 0x82,
	MEMCACHED_RES_NOT_SUPPORTED   = 0x83,
	MEMCACHED_RES_SERVER_ERROR    = 0x84, /* No in memc */
	MEMCACHED_RES_EBUSY           = 0x85, /* No in memc */
	MEMCACHED_RES_EAGAIN          = 0x86, /* No in memc */
	MEMCACHED_RES_MAX
};
